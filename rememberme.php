...
if(!empty($_COOKIE['rememberme'])){
    ...
    $sql = "SELECT * FROM rememberme where authenticator1 = '$authentificator1'";
...
//              
//        //echo  "<div class='alert alert-danger'> $authentificator1.....$f2authentificator2....$user_id....$expiration</div>"; 
//
//        $result = mysqli_query($link, $sql);
//        if(!$result){
