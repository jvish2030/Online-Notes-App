...
$link = @mysqli_connect("localhost","technoph_users","mWJPovYA","technoph_users") or die("ERROR: Unable to connect: " . mysqli_connect_error());
 ...
 //check for errors
    ...
    if($errors){
        ...
        if(!$id){
            ...
            $sql = "INSERT INTO table_DB (firstname, lastname, email, password) VALUES ('$firstname', '$lastname', '$email', '$password')";   

        }else{

            $sql = "INSERT INTO table_DB (ID, firstname, lastname, email, password) VALUES ('$id', '$firstname', '$lastname', '$email', '$password')";   
